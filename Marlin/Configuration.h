 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.889, 88.889, 88.889, 439.5 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define MANUAL_Z_HOME_POS 301// Distance between the nozzle to printbed after homing
